...
exports.defineManualTests = function (contentEl, createActionButton) {
    ...
    var dialogs_tests = '<div id="beep"></div>' +
        ...
        '<p/> <div id="prompt"></div>' +
        'Expected result: Dialog will say "You pressed prompt". Enter any myClass and press Yes, No, or Maybe, Not Sure to close dialog. Status box will tell you what option you selected and myClass you entered or if empty, it will display "Default Text", and should use 1-based indexing.' +
